...
const int speed= 100;
const int side_speed=speed*0.40;
...
void loop()
{
  ...
  while(Average_Left_Front_Distance(20) < 80 && Average_Right_Front_Distance(20) > 80){
    xmotion.Left0(side_speed, 7.5);
  }

  while(Average_Left_Front_Distance(20) > 80 && Average_Right_Front_Distance(20) < 80)
  {
    xmotion.Right0(side_speed, 7.5);
  }

  if(Average_Left_Front_Distance(20) < 80 && Average_Right_Front_Distance(20) < 80)
  {
    xmotion.Forward(speed, 100);
  }
